...
.constant("baseURL","https://dineatconfusion.herokuapp.com/")
.factory('menuFactory', ['$resource', 'baseURL', function($resource, baseURL) {

    // returns all the dishes, in case of update PUT verb is used
...
.factory('AuthFactory', ['$resource', '$http', '$localStorage', '$rootScope', '$window', 'baseURL',
                         'ngDialog', function($resource, $http, $localStorage, $rootScope, $window,
                                              baseURL, ngDialog){
